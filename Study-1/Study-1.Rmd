...
p_combined <- ggplot(df_combined, aes(x = Condition, y = freq*100, fill = Condition)) +
  ...
  labs(x = "Feedback on % of experts who...", y = "% of Selected Experts with the Target Attribute",
...
# Save the plot
ggsave("Figure-Study1.pdf", plot = p_combined, width = 10, height = 8, units = "in", device = cairo_pdf, family = "Times New Roman")
ggsave("Figure-Study1.png", plot = p_combined, width = 10, height = 8, units = "in", dpi = 600)
```

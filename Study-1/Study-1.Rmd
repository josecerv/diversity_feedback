...
# Load and register Times New Roman font
# Only run font_import() once - it takes a while
...
if(USE_API) {
  ...
  d0 <- qual_data |>
    ...
    dplyr::select(treatment, set_num, women_feedback, age_feedback, location_feedback, university_feedback,
                  women_count, women_proportion, women_choice3, age_count, age_proportion,
...
## logistic regression
# Fit the logistic regression model using the third (final) choice
r4 <- glm(women_choice3 ~ women_feedback, family = binomial, data=d0)

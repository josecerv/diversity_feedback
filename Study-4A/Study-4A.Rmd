...
if(USE_API) {
  ...
  d0 <- read.csv('Study4A.csv', check.names = F)
...
if(USE_API) {
  ...
  write.csv(d0, 'Study4A.csv', row.names = FALSE, quote = TRUE)
}
...
t.test(base_race/6 ~ race_feedback, data=d0)
```
...
saveRDS(study4A_estimates, file = "../Manuscript_Figures/figure2-estimates/study4A_estimates.rds")
...
# saveRDS(p_combined, file = "p_combined_study4A.rds")
# 
# # Save the plot
# ggsave("Figure-Study4A.pdf", plot = p_combined, width = 10, height = 8, units = "in", device = cairo_pdf, family = "Times New Roman")
# ggsave("Figure-Study4A.png", plot = p_combined, width = 10, height = 8, units = "in", dpi = 600)
```

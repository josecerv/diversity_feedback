# Figure 2: Tree plot showing effect sizes across 6 studies
...
# Define the path to the estimates (relative from scripts folder)
estimate_path <- "../data/"
...
# Fix study names to match numbering scheme
...
ggsave("../Figure-2.png", combined_plot, width = 16, height = 24, units = "in", dpi = 600)

cat("Figure-2.png saved successfully!\n")

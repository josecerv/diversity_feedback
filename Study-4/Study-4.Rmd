---
title: "Study 5: Field Experiment"
...
d0 <- d0 |> 
  ...
  select(gender_feedback:entertainer_pick, gender, base_gender, `choice-1`:`choice-7`, race,age, gender_code, race_code) 
...
###########################################################################################
# when reading the csv, use the following command: read.csv('Study5.csv', check.names = F)
###########################################################################################
```
...
p_combined <- ggplot(df_combined, aes(x = Condition, y = freq*100, fill = Condition)) +
  ...
  theme(text = element_text(family = "Times New Roman"),
        ...
        axis.title.x = element_text(face="bold", size = 16, vjust = 21, family = "Times New Roman"),
...
ggsave("Figure-6.pdf", plot = p_combined, width = 10, height = 8, units = "in", device = cairo_pdf, family = "Times New Roman")

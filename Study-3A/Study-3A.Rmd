...
if(USE_API) {
  ...
  d0 <- read.csv('Study3A.csv', check.names = F)
...
saveRDS(study3A_estimates, file = "../Manuscript_Figures/figure2-estimates/study3A_estimates.rds")

```

\newpage

## Figure S2 Figure Code
...
d_budget_plot <- d0 |>
  dplyr::select(budget_shown, budget_pick) |>
...
d_duration_plot <- d0 |>
  dplyr::select(duration_shown, duration_pick) |> 
...
# # Save the plot
# ggsave("Figure-Study3A.pdf", plot = p_combined_B, width = 10, height = 8, units = "in", device = cairo_pdf, family = "Times New Roman")
# ggsave("Figure-Study3A.png", plot = p_combined_B, width = 10, height = 8, units = "in", dpi = 600)

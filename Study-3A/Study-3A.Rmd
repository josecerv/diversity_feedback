...
# Save the plot
ggsave("Figure-Study2A.pdf", plot = p_combined_B, width = 10, height = 8, units = "in", device = cairo_pdf, family = "Times New Roman")
ggsave("Figure-Study2A.png", plot = p_combined_B, width = 10, height = 8, units = "in", dpi = 600)

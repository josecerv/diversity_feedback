...
# Save the plot
ggsave("Figure-Study3A.pdf", plot = p_combined, width = 10, height = 8, units = "in", device = cairo_pdf, family = "Times New Roman")
ggsave("Figure-Study3A.png", plot = p_combined, width = 10, height = 8, units = "in", dpi = 600)
```

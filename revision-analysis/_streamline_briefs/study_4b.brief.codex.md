# Brief: streamline Study 4B Methods + Results + Mediation + Pretest
...
# STUDY-SPECIFIC PRESERVATION RULES for Study 4B Methods + Results + Mediation + Pretest
...
# PRIOR POST-KATY DRAFT for Study 4B Methods + Results + Mediation + Pretest (calibration anchor; do NOT copy verbatim — use only as a comparison reference)

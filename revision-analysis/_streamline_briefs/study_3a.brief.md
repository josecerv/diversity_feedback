# Brief: streamline Study 3A Methods + Results
...
# STUDY-SPECIFIC PRESERVATION RULES for Study 3A Methods + Results
...
# PRIOR POST-KATY DRAFT for Study 3A Methods + Results (calibration anchor; do NOT copy verbatim — use only as a comparison reference)

...
## Mediation Path Summary: Women Underrepresented Pool

```{r path-summary-underrep, echo=FALSE, results='markup'}
cat("=======================================================\n")
cat("MEDIATION PATH SUMMARY: WOMEN UNDERREPRESENTED POOL\n")
cat("=======================================================\n\n")

cat("N =", nrow(d_men_pool), "\n\n")

# c path (total effect)
cat("=== TOTAL EFFECT (c path) ===\n")
cat("Model: female_pick ~ treatment\n\n")
robust_summary(dir.fit.fairness.underrep)
robust_confint(dir.fit.fairness.underrep)
...
cat("--- Fairness ---\n")
cat("Model: fairness ~ treatment\n")
cat("a =", round(coef(med.fit.fairness.underrep)["treatment"], 4), "\n")
cat("SE =", round(sqrt(diag(vcovHC(med.fit.fairness.underrep, type = "HC3")))["treatment"], 4), "\n")
cat("p =", round(robust_summary(med.fit.fairness.underrep)$coefficients["treatment", "Pr(>|t|)"], 4), "\n\n")

cat("--- Internal Motivation ---\n")
cat("Model: internal_motivation ~ treatment\n")
cat("a =", round(coef(med.fit.internal.underrep)["treatment"], 4), "\n")
cat("SE =", round(sqrt(diag(vcovHC(med.fit.internal.underrep, type = "HC3")))["treatment"], 4), "\n")
cat("p =", round(robust_summary(med.fit.internal.underrep)$coefficients["treatment", "Pr(>|t|)"], 4), "\n\n")

cat("--- External Motivation ---\n")
cat("Model: external_motivation ~ treatment\n")
cat("a =", round(coef(med.fit.external.underrep)["treatment"], 4), "\n")
cat("SE =", round(sqrt(diag(vcovHC(med.fit.external.underrep, type = "HC3")))["treatment"], 4), "\n")
cat("p =", round(robust_summary(med.fit.external.underrep)$coefficients["treatment", "Pr(>|t|)"], 4), "\n")
...
cat("--- Fairness ---\n")
cat("Model: female_pick ~ treatment + fairness\n")
cat("b (fairness) =", round(coef(out.fit.fairness.underrep)["fairness"], 4), "\n")
cat("SE =", round(sqrt(diag(vcovHC(out.fit.fairness.underrep, type = "HC3")))["fairness"], 4), "\n")
cat("p =", round(robust_summary(out.fit.fairness.underrep)$coefficients["fairness", "Pr(>|t|)"], 4), "\n")
cat("c' (direct) =", round(coef(out.fit.fairness.underrep)["treatment"], 4), "\n")
cat("SE =", round(sqrt(diag(vcovHC(out.fit.fairness.underrep, type = "HC3")))["treatment"], 4), "\n")
cat("p =", round(robust_summary(out.fit.fairness.underrep)$coefficients["treatment", "Pr(>|t|)"], 4), "\n\n")

cat("--- Internal Motivation ---\n")
cat("Model: female_pick ~ treatment + internal_motivation\n")
cat("b (internal) =", round(coef(out.fit.internal.underrep)["internal_motivation"], 4), "\n")
cat("SE =", round(sqrt(diag(vcovHC(out.fit.internal.underrep, type = "HC3")))["internal_motivation"], 4), "\n")
cat("p =", round(robust_summary(out.fit.internal.underrep)$coefficients["internal_motivation", "Pr(>|t|)"], 4), "\n")
cat("c' (direct) =", round(coef(out.fit.internal.underrep)["treatment"], 4), "\n")
cat("SE =", round(sqrt(diag(vcovHC(out.fit.internal.underrep, type = "HC3")))["treatment"], 4), "\n")
cat("p =", round(robust_summary(out.fit.internal.underrep)$coefficients["treatment", "Pr(>|t|)"], 4), "\n\n")

cat("--- External Motivation ---\n")
cat("Model: female_pick ~ treatment + external_motivation\n")
cat("b (external) =", round(coef(out.fit.external.underrep)["external_motivation"], 4), "\n")
cat("SE =", round(sqrt(diag(vcovHC(out.fit.external.underrep, type = "HC3")))["external_motivation"], 4), "\n")
cat("p =", round(robust_summary(out.fit.external.underrep)$coefficients["external_motivation", "Pr(>|t|)"], 4), "\n")
cat("c' (direct) =", round(coef(out.fit.external.underrep)["treatment"], 4), "\n")
cat("SE =", round(sqrt(diag(vcovHC(out.fit.external.underrep, type = "HC3")))["treatment"], 4), "\n")
cat("p =", round(robust_summary(out.fit.external.underrep)$coefficients["treatment", "Pr(>|t|)"], 4), "\n")

# Summary table
cat("\n\n=== BOOTSTRAP INDIRECT EFFECTS SUMMARY (10,000 simulations) ===\n\n")

summary_table_underrep <- data.frame(
  Mediator = c("Fairness", "Internal Motivation", "External Motivation"),
  a_path = c(round(coef(med.fit.fairness.underrep)["treatment"], 3),
             round(coef(med.fit.internal.underrep)["treatment"], 3),
             round(coef(med.fit.external.underrep)["treatment"], 3)),
  b_path = c(round(coef(out.fit.fairness.underrep)["fairness"], 3),
             round(coef(out.fit.internal.underrep)["internal_motivation"], 3),
             round(coef(out.fit.external.underrep)["external_motivation"], 3)),
  ACME = c(round(med.out.fairness.underrep$d0, 4),
           round(med.out.internal.underrep$d0, 4),
           round(med.out.external.underrep$d0, 4)),
  ACME_CI_lower = c(round(med.out.fairness.underrep$d0.ci[1], 4),
                    round(med.out.internal.underrep$d0.ci[1], 4),
                    round(med.out.external.underrep$d0.ci[1], 4)),
  ACME_CI_upper = c(round(med.out.fairness.underrep$d0.ci[2], 4),
                    round(med.out.internal.underrep$d0.ci[2], 4),
                    round(med.out.external.underrep$d0.ci[2], 4)),
  ACME_p = c(round(med.out.fairness.underrep$d0.p, 4),
             round(med.out.internal.underrep$d0.p, 4),
             round(med.out.external.underrep$d0.p, 4))
)

print(summary_table_underrep)

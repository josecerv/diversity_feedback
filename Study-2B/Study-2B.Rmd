...
saveRDS(study2B_estimates, file = "../Manuscript_Figures/figure4-estimates/study2B_estimates.rds")
...
# Save the plot
ggsave("Figure-Study2B.pdf", plot = p_combined_A, width = 10, height = 8, units = "in", device = cairo_pdf, family = "Times New Roman")
ggsave("Figure-Study2B.png", plot = p_combined_A, width = 10, height = 8, units = "in", dpi = 600)

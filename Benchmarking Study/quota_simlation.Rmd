...
datasets <- list(
  ...
  s3a = list(data = s3a, type = "gender"),
  s3b = list(data = s3b, type = "race")
)
...
stargazer(models$s1a, models$s1b, models$s3a, models$s3b,
          type = "latex",
          column.labels = c("Study 1A", "Study 1B", "Study 3A", "Study 3B"),
          model.numbers = FALSE,
          se = list(robust_se$s1a, robust_se$s1b, robust_se$s3a, robust_se$s3b),
          keep.stat = c("n", "rsq"),
...
wald_results$Study <- c("Study 1A", "Study 1B", "Study 3A", "Study 3B")

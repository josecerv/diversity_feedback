...
###########################################################################################
# when reading the csv, use the following command: read.csv('Study1A.csv', check.names = F)
###########################################################################################
```
...
ggsave("Figure-2A.pdf", plot = p_combined_A, width = 10, height = 8, units = "in", device = cairo_pdf, family = "Times New Roman")

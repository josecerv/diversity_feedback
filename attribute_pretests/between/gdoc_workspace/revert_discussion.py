"""Revert Discussion to the version just before the R1-language swap:
the shorter underpowered caveat (no 'comparison attribute is common in its
candidate pool' clause).
"""

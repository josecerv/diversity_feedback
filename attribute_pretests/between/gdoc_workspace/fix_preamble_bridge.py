"""Tighten the preamble's bridge sentence: keep response-letter prediction
phrasing, but make the connection between 'appropriate use' (sentence 1)
and 'underrepresentation' (sentence 3) explicit in one sentence.
"""
...
PREAMBLE_NEW = (
    ...
    "authors). Because these participants selected none of the focal "
    "attribute, they cannot have been using it appropriately in their initial "
    "selections, and we propose this absence is a conservative signal of "
    "underrepresentation that should provoke a reaction to feedback regardless "
    "of which attribute is involved."
)

# Figure S6: Study S2B - Two cells combined (two-panel figure)
...
p_combined_A <- readRDS("../data/p_combined_S2B_A.rds")
# Panel B (with encouragement)
p_combined_B <- readRDS("../data/p_combined_S2B_B.rds")
...
# Save to PNG (Figure S6) - consistent with manuscript: 14x19, 600 dpi
ggsave("../Figure-S6.png", plot = final_plot, width = 14, height = 19, dpi = 600)

cat("Figure-S6.png saved successfully!\n")

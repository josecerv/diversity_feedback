...
p_combined_A <- readRDS("../S2B/p_combined_S2B_A.rds")
# Panel B (with encouragement)
p_combined_B <- readRDS("../S2B/p_combined_S2B_B.rds")
...
# Save to PDF (Figure S6)
ggsave("Figure-S6.pdf", family = "Times New Roman", plot = final_plot,

...
write.csv(d0, 'StudyS2.csv', row.names = FALSE, quote = TRUE) 

###########################################################################################
# when reading the csv, use the following command: read.csv('StudyS2.csv', check.names = F)
###########################################################################################
```
...
ggsave("FigureS5.pdf", combined_plot, width = 16, height = 7, units = "in", device = cairo_pdf, family = "Times New Roman")
```

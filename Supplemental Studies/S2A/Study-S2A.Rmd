...
# Save individual plot objects as RDS for combination in figure-S5.R
saveRDS(p_combined_A, file = "p_combined_S2A_A.rds")
saveRDS(p_combined_B, file = "p_combined_S2A_B.rds")
```
